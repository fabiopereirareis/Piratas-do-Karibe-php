    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
            <div class="card h-100">
                <img src="assets/img/franquia.jpg" class="card-img-top" alt="Foto de Arturo Anez no Pexels" />
                <div class="card-body">
        ...
        <div class="col">
            <div class="card h-8">
                <img src="assets/img/planos.jpg" class="card-img-top" alt="Foto de Tima Miroshnichenko no Pexels" />
                <div class="card-body">
