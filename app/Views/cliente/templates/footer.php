<footer class="pt-4 my-md-5 pt-md-5 border-top container py-3">
    <div class="row">
        <div class="col-12 col-md">
            <img class="mb-2" src="assets/brand/bootstrap-logo.svg" alt="" width="24" height="19" />
            <small class="d-block mb-3 text-muted">&copy; 2017–2021</small>

            <img class="mb-2" src="assets/brand/new-php-logo.svg" alt="" width="35" height="30" />
            <small class="d-block mb-3 text-muted">&copy; 2001–2021</small>
        </div>
